...
function CustomButton({
    ...
    const variantStyles = {
        primary: "bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 hover:scale-105 hover:from-purple-600 hover:via-purple-400 hover:to-purple-600 hover:outline outline-offset-2 outline-purple-500 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80"
    }
